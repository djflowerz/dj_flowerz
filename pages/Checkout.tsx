...
import { Truck, CreditCard, ShieldCheck, MapPin, ChevronDown, Check, MessageSquare } from 'lucide-react';
...
export default function Checkout() {
  ...
  // Auto-select zone based on county
  React.useEffect(() => {
    if (selectedCounty) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-500 font-medium">Review your order and shipping details</p>
          </div>
        </div>
            ...
            <form id="checkout-form" onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="bg-[#15151A] rounded-[2.5rem] border border-white/5 p-8 space-y-6 shadow-2xl">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-black tracking-tight uppercase">Shipping Information</h3>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#0B0B0F] border border-white/10 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-none transition-all placeholder:text-gray-700 font-medium"
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      {...register('phone', {
                        ...
                        pattern: {
                          value: /^(?:254|\+254|0)?(7|1)(?:(?:[0-9][0-9])|(?:[0-9][0-9]))[0-9]{6}$/,
                          message: "Invalid Kenyan phone number (e.g. 07xx xxx xxx)"
                        }
                      })}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full bg-[#0B0B0F] border border-white/10 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-none transition-all appearance-none cursor-pointer font-medium"
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="e.g. Westlands, Nyali, Eldoret CBD"
                      className="w-full bg-[#0B0B0F] border border-white/10 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-none transition-all placeholder:text-gray-700 font-medium"
                    />
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <input
                      type="text"
                      {...register('buildingDetails', { required: "Details are required" })}
                      placeholder="e.g. Garden Estate, Block B, House 4"
                      className="w-full bg-[#0B0B0F] border border-white/10 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-none transition-all placeholder:text-gray-700 font-medium"
                    />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-white/5 md:col-span-2">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-black text-gray-400 uppercase tracking-widest pl-1">Order Notes / Gift Message</label>
                      <input
                        type="text"
                        {...register('orderNotes')}
                        placeholder="e.g. Leave at security, This is a gift"
                        className="w-full bg-[#0B0B0F] border border-white/10 rounded-2xl py-4 px-6 focus:ring-2 focus:ring-brand-purple focus:border-transparent outline-none transition-all placeholder:text-gray-700 font-medium"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2 flex items-center gap-3 p-4 bg-brand-purple/5 rounded-2xl border border-brand-purple/10">
                      <input
                        ...
                        className="w-5 h-5 rounded border-white/10 bg-black/40 text-brand-purple focus:ring-brand-purple bg-transparent"
                      />
              ...
              <div className="bg-[#15151A] rounded-[2.5rem] border border-white/5 p-8 space-y-8 shadow-2xl">
                ...
                <div className="space-y-6">
                  ...
                  {/* Rate Selection for the active zone */}
              ...
              <div className="bg-[#15151A] rounded-[2.5rem] border border-white/5 p-8 space-y-6 shadow-2xl">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 opacity-30 grayscale contrast-125">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/M-PESA_LOGO-01.svg/1200px-M-PESA_LOGO-01.svg.png" className="h-6 object-contain" alt="M-Pesa" />
            ...
            <div className="bg-[#15151A] rounded-[2.5rem] border border-white/5 p-8 sticky top-28 shadow-2xl space-y-8">
              ...
              <div className="space-y-3 pt-6 border-t border-white/5">
                ...
                <div className="flex justify-between items-center px-2">
                  ...
                  <span className="text-sm font-bold text-brand-cyan">KES {shippingCost.toLocaleString()}</span>
                </div>
