...
const MarketplaceStorefront: React.FC = () => {
  const [items, setItems] = useState<MarketplacePost[]>([]);
      ...
      <div className="flex pt-20 h-screen overflow-hidden">
        ...
        <aside className="hidden lg:flex flex-col h-full py-8 bg-[#050508] border-r border-white/10 w-72 shrink-0">
          <div className="px-8 mb-10">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <div className="text-[10px] uppercase tracking-widest text-[#7c3aed] font-bold">Reputation: Top Tier</div>
              </div>
            </div>
            <nav className="space-y-1">
              ...
              <Link to="/marketplace/dashboard" className="flex items-center gap-4 px-4 py-3 rounded-xl font-['Space_Grotesk'] uppercase font-bold text-xs tracking-widest transition-all text-white/40 hover:text-white/80 hover:bg-white/5">
                <Wallet size={18} />
                <span>Active Secure Purchases</span>
              </Link>
            </nav>
          </div>
          ...
          <div className="px-8 space-y-8 overflow-y-auto custom-scrollbar flex-1 pb-10">
            ...
            {/* Verification */}
            <div className="bg-white/[0.03] rounded-2xl p-6 border border-white/5">
              <h3 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-4">VERIFICATION FILTER</h3>
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-[10px] font-black text-[#4cd7f6] tracking-widest uppercase">Verified Members Only</span>
              </label>
            </div>
          </div>
          ...
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-8">
              <div className="space-y-2">
                ...
                <h1 className="text-6xl font-black text-white uppercase tracking-tighter leading-none font-['Space_Grotesk']">Equipment & Services</h1>
                <p className="text-white/40 text-lg max-w-xl">Secure equipment exchange for the community. Powered by Secure Escrow.</p>
              </div>

              <div className="flex items-center gap-4">
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-full p-1 flex">
                  <button className="px-6 py-2 bg-white/10 text-white rounded-full font-black text-[10px] tracking-widest transition-all">ALL ITEMS</button>
                  <button className="px-6 py-2 text-white/40 hover:text-white rounded-full font-black text-[10px] tracking-widest transition-all">NEW LISTINGS</button>
                </div>
              </div>
            </div>
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-32 space-y-4">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#7c3aed]">Loading marketplace...</p>
              </div>
                    ...
                    <div className="relative h-72 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <div className="flex items-center gap-1.5 px-3 py-1.5 bg-black/60 backdrop-blur-xl border border-[#4cd7f6]/50 rounded-lg shadow-2xl">
                          ...
                          <span className="text-[9px] font-black text-[#4cd7f6] tracking-widest uppercase">SECURE ESCROW</span>
                        </div>
                      </div>
                         ...
                         <div className="w-full flex items-center justify-between">
                            <div className="flex items-center gap-2">
                               ...
                               <div>
                                  ...
                                  <p className="text-[9px] text-[#4cd7f6] font-bold uppercase tracking-widest">Reputation: 98</p>
                               </div>
                            </div>
