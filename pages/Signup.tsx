...
const Signup: React.FC = () => {
  ...
  const { register, signInWithGoogle, signInWithFacebook, signInWithTikTok } = useAuth();
    ...
    <div className="min-h-screen pt-24 pb-20 flex items-center justify-center bg-[#0B0B0F]">
      <div className="w-full max-w-md p-8 bg-[#15151A] rounded-2xl border border-white/10 shadow-2xl">
        ...
        <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs text-gray-500 uppercase"><span className="bg-[#15151A] px-2">Or continue with email</span></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full py-4 bg-brand-cyan text-black font-bold rounded-lg hover:bg-cyan-400 transition shadow-lg shadow-brand-cyan/20 mt-4">
            Sign Up
          </button>
        </form>
