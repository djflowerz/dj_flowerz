/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a68bf969aee28b1568d3587e03a834f)
// Runtime types generated with workerd@1.20260421.1 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "AdminHub";
	}
	interface ProductionEnv {
		...
		EMAIL: SendEmail;
		AI: Ai;
		PUBLIC_R2_DOMAIN: "pub-8ce7dd1a0bfc42fb9e3a130e1f5f5aae.r2.dev";
		ENVIRONMENT: "production";
		EMAIL_FROM: "verify@djflowerz.co.ke";
		EMAIL_FROM_NAME: "DJ Flowerz";
		...
		VITE_STORAGE_WORKER_URL: string;
		VITE_R2_URL: string;
		...
		VITE_PLAN_12_MONTHS: string;
		VITE_PLAN_1_MONTH: string;
		VITE_PLAN_1_WEEK: string;
		VITE_PLAN_3_MONTHS: string;
		VITE_PLAN_6_MONTHS: string;
		VITE_SITE_URL: string;
		ADMIN_HUB: DurableObjectNamespace<import("./index").AdminHub>;
	}
	interface Env {
		KV: KVNamespace;
		R2_BUCKET: R2Bucket;
