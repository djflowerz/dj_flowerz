...
-- 1. Enable Storage Extenstion (if not already)
-- Usually enabled by default in Supabase projects.
...
-- -------------------------------------------------------
-- Optional: Users uploading their own Avatar?
-- If users need to upload avatars to 'images' bucket:
-- -------------------------------------------------------
/*
...
WITH CHECK (
    ...
    AND (storage.foldername(name))[1] = 'avatars' -- Validation logic usually better in app
);
*/
